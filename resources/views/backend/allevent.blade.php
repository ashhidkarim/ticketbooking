                                            ...
                                            <table class="table align-middle table-nowrap" id="customerTable">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="customer_name">Event Title</th>
                                                        <th class="sort" data-sort="email">Organizer</th>
                                                        <th class="sort" data-sort="phone">Type</th>
                                                        <th class="sort" data-sort="date">Category</th>
                                                        <th class="sort" data-sort="status">Location</th>
                                                        <th class="sort" data-sort="action">Start Date</th>
                                                         <th class="sort" data-sort="action">End Date</th>
                                                    </tr>
                                                </thead>
                                                <tbody class="list form-check-all">
                                                    <tr>
                                                        ...
                                                        <td class="phone">Events</td>
                                                        <td class="date">Musics Night</td>
                                                        <td class="status">Delhi</td>
                                                        <td class="status">10.10.2022</td>
                                                        <td class="status">11.10.2022</td>
                                                        <td>
                                            ...
                                            <ul class="list list-group list-group-flush mb-0">
                                                <li class="list-group-item" data-id="1">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div>
                                                                <img class="image avatar-xs rounded-circle" alt="" src="{{asset('admins/images/users/avatar-1.jpg')}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="list-group-item" data-id="2">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div>
                                                                <img class="image avatar-xs rounded-circle" alt="" src="{{asset('admins/images/users/avatar-2.jpg')}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="list-group-item" data-id="3">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div>
                                                                <img class="image avatar-xs rounded-circle" alt="" src="{{asset('admins/images/users/avatar-3.jpg')}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="list-group-item" data-id="4">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div>
                                                                <img class="image avatar-xs rounded-circle" alt="" src="{{asset('admins/images/users/avatar-4.jpg')}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                            ...
                            <div class="modal-content">
                                ...
                                <form>
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="customername-field" class="form-label">Event Title</label>
                                            <input type="text" id="customername-field" class="form-control" placeholder="Event Title" required />
                                        </div>

                                        <div class="mb-3">
                                            <label for="email-field" class="form-label">Organizer</label>
                                            <input type="email" id="email-field" class="form-control" placeholder="Organizer" required />
                                        </div>

                                        <div class="mb-3">
                                            <label for="phone-field" class="form-label">Type</label>
                                            <input type="text" id="phone-field" class="form-control" placeholder="Type" required />
                                        </div>

                                        <div class="mb-3">
                                            <label for="date-field" class="form-label">Category</label>
                                            <input type="text" id="date-field" class="form-control" placeholder="Category" required />
                                        </div>

                                        <div class="mb-3">
                                            <label for="status-field" class="form-label">Location</label>
                                               <input type="text" id="date-field" class="form-control" placeholder="Location" required />
                                        </div>
                                        <div class="row">

                                            <div class="col-xl-6">
                                            <label for="status-field" class="form-label">Start Date</label>
                                               <input type="Date" id="date-field" class="form-control" placeholder="Start Date" required />
                                               </div>
                                                <div class="col-xl-6">
                                            <label for="status-field" class="form-label">End Date</label>
                                               <input type="Date" id="date-field" class="form-control" placeholder="End Date" required />
                                               </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <div class="hstack gap-2 justify-content-end">
                                            ...
                                            <button type="submit" class="btn btn-success" id="add-btn">Add Event</button>
